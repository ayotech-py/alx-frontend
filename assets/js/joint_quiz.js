...
async function fetchQuestion() {
    let response = await fetch(`https://web-01.ayotech-py.tech/letsquiz_api/quiz_questions?quiz_id=${quiz_id}`)
...
async function setScore(user_score) {
    ...
    let response = await fetch('https://web-01.ayotech-py.tech/letsquiz_api/quiz_set_score/', {
        method: "POST",
        body: JSON.stringify({
            "quiz_id": quiz_id,
            'name': name,
